...
function renderCacheOnMap(
  ...
  // Use the generateCachePopup function to bind the popup
  rect.bindPopup(() => generateCachePopup(newCache, i, j));
}

function generateCachePopup(newCache: Cache, i: number, j: number) {
